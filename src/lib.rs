...
//! also provides batch and causal streaming reassignment and
//! synchrosqueezing, an end-to-end GCFB/Breebaart hybrid, and an ideal-observer
//! template. Matrices are channel-major: rows are filter channels and columns
//! are samples or frames.
